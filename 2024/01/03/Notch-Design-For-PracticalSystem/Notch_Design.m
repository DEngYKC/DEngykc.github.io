...
y_practical_notch_zero=y_temp;
Gp_Practical_notch_zero=Gp_temp;
...
fprintf('Practical-Ideal Square area(Abs) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_OnlyPositive(log10(x),log10(y_practical),log10(y_ideal));
fprintf('Practical-Ideal Square area(Only+) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_OnlyNegtive(log10(x),log10(y_practical),log10(y_ideal));
fprintf('Practical-Ideal Square area(Only-) is %f\n',sum);

sum=Curved_Surface_Integral_Forward_abs(log10(x),log10(y_practical_notch),log10(y_ideal));
fprintf('Practical_Notch-Ideal area(Abs) is %f\n',sum);
sum=Curved_Surface_Integral_Forward_OnlyPositive(log10(x),log10(y_practical_notch),log10(y_ideal));
fprintf('Practical_Notch-Ideal area(Only+) is %f\n',sum);
sum=Curved_Surface_Integral_Forward_OnlyNegtive(log10(x),log10(y_practical_notch),log10(y_ideal));
fprintf('Practical_Notch-Ideal area(Only-) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_abs(log10(x),log10(y_practical_notch),log10(y_ideal));
fprintf('Practical_Notch-Ideal Square area(Abs) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_OnlyPositive(log10(x),log10(y_practical_notch),log10(y_ideal));
fprintf('Practical_Notch-Ideal Square area(Only+) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_OnlyNegtive(log10(x),log10(y_practical_notch),log10(y_ideal));
fprintf('Practical_Notch-Ideal Square area(Only-) is %f\n',sum);

sum=Curved_Surface_Integral_Forward_abs(log10(x),log10(y_practical_notch_zero),log10(y_ideal));
fprintf('Practical_Notch_Zero-Ideal area(Abs) is %f\n',sum);
sum=Curved_Surface_Integral_Forward_OnlyPositive(log10(x),log10(y_practical_notch_zero),log10(y_ideal));
fprintf('Practical_Notch_Zero-Ideal area(Only+) is %f\n',sum);
sum=Curved_Surface_Integral_Forward_OnlyNegtive(log10(x),log10(y_practical_notch_zero),log10(y_ideal));
fprintf('Practical_Notch_Zero-Ideal area(Only-) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_abs(log10(x),log10(y_practical_notch_zero),log10(y_ideal));
fprintf('Practical_Notch_Zero-Ideal Square area(Abs) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_OnlyPositive(log10(x),log10(y_practical_notch_zero),log10(y_ideal));
fprintf('Practical_Notch_Zero-Ideal Square area(Only+) is %f\n',sum);
sum=Curved_Surface_Integral_Square_Forward_OnlyNegtive(log10(x),log10(y_practical_notch_zero),log10(y_ideal));
fprintf('Practical_Notch_Zero-Ideal Square area(Only-) is %f\n',sum);
